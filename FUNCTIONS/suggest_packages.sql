...
--
TRUNCATE magicmake.trace_files, magicmake.trace_commands, magicmake.missing_files, magicmake.missing_dirs;
--
...
JOIN magicmake.package_dirs
  ON package_dirs.dir_path = trace_files.file_path;
-- WHERE trace_files.missing;
